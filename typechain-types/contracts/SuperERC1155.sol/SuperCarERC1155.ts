...
export interface SuperCarERC1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface SuperCarERC1155 extends BaseContract {
  connect(runner?: ContractRunner | null): SuperCarERC1155;
  waitForDeployment(): Promise<this>;

  interface: SuperCarERC1155Interface;
  ...
  burnToken: TypedContractMethod<
    [id: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  mint: TypedContractMethod<
    [id: BigNumberish, mintAmount: BigNumberish],
    [void],
    "payable"
  >;
